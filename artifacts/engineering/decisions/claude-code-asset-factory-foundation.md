...
| P0-CC-004 | P0 governance/safety | Git/workflow/team boundary | A local Git repository now exists, but canonical remote/history/provenance and workflow/team proof remain unverified. | Trust policy CC-7 predicates and Claude worktree boundary | Cannot safely enable worktrees, teams, or parallel writers. | External owner supplies canonical Git/GitHub proof and conflict/isolation tests. | External repository owner + CODEOWNERS | false | No clone, remote binding, history/provenance inference, or enablement. |
...
no Git clone, remote binding, or history/provenance inference
