...
4. owner contracts have required lifecycle state;
...
Observe cost per accepted evaluation, primary/escalation cost, retry waste, optional feedback/content-operation cost and cost per verified improvement. A cheaper route fails when the required quality/learner-path integrity floor fails.

## Update rule

- Semantic change can return a family to implementation review.
